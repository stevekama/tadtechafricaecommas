...
@section('content')
                ...
                <div class="col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style">
                    ...
                    <div class="slider__container slider--one">
                        <div class="slider__activation__wrap owl-carousel owl-theme">
                            <!-- Start Single Slide -->
                            <div class="slide slider__full--screen slider-height-inherit slider-text-right" style="background: rgba(0, 0, 0, 0) url({{asset('storage/images/slider/bg/1.png')}}) no-repeat scroll center center / cover ;">
                                <div class="container">
                                    <div class="row">
                            ...
                            <!-- End Single Slide -->
                            <!-- Start Single Slide -->
                            <div class="slide slider__full--screen slider-height-inherit  slider-text-left" style="background: rgba(0, 0, 0, 0) url({{asset('storage/images/slider/bg/2.png')}}) no-repeat scroll center center / cover ;">
                                <div class="container">
                                    <div class="row">
                    ...
                    <div class="categories-menu mrg-xs">
                        ...
                        <div class="category-menu-list">
                            <ul>
                                <li>
                                    <a href="#">
                                        <img alt="" src="{{asset('storage/images/icons/thum2.png')}}"> Women’s Clothing <i class="zmdi zmdi-chevron-right"></i>
                                    </a>
                                ...
                                <li><a href="#"><img alt="" src="{{asset('storage/images/icons/thum3.png')}}"> Man Fashion <i class="zmdi zmdi-chevron-right"></i></a>
                                    <div class="category-menu-dropdown">
                                ...
                                <li><a href="#"><img alt="" src="{{asset('storage/images/icons/thum6.png')}}"> Men’s Clothing <i class="zmdi zmdi-chevron-right"></i></a>
                                    <div class="category-menu-dropdown">
                                        <div class="category-menu-dropdown-left">
                                ...
                                <li><a href="#"><img alt="" src="{{asset('storage/images/icons/thum2.png')}}"> Consumer Electronics</a></li>
                                <li><a href="#"><img alt="" src="{{asset('storage/images/icons/thum3.png')}}"> all Accessories</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="only-banner ptb--100 bg__white">
        <div class="container">
            <div class="only-banner-img">
                <a href="#"><img src="{{asset('storage/images/new-product/3.jpg')}}" alt="new product"></a>
            </div>
        </div>
    </div>
    ...
    <div class="only-banner ptb--100 bg__white">
        <div class="container">
            <div class="only-banner-img">
                <a href="shop-sidebar.html"><img src="{{asset('storage/images/new-product/6.jpg')}}" alt="new product"></a>
            </div>
        </div>
    </div>
    <!-- Start Our Product Area -->
    ...
    <div class="only-banner bg__white">
        <div class="container">
            <div class="only-banner-img">
                <a href="shop-sidebar.html"><img src="{{asset('storage/images/new-product/7.jpg')}}" alt="new product"></a>
            </div>
        </div>
    </div>
                            ...
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="{{asset('storage/images/blog/blog-img/1.jpg')}}" alt="blog images">
                                    </a>
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                        <div class="blog foo">
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="{{asset('storage/images/blog/blog-img/2.jpg')}}" alt="blog images">
                                    </a>
                                    <div class="blog__post__time">
                                        <div class="post__time--inner">
                                            <span class="date">14</span>
                    ...
                    <div class="col-md-4 col-lg-4 hidden-sm col-xs-12">
                        <div class="blog foo">
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="{{asset('storage/images/blog/blog-img/3.jpg')}}" alt="blog images">
                                    </a>
                                    <div class="blog__post__time">
                                        <div class="post__time--inner">
                                            <span class="date">14</span>
